...
if(isset($_GET["rid"]))
{
	...
	$Conn->query($upqry);
	header("location:Acceptedagency.php");	
}
...
<h3 align="center" >Seater</h3>
    ...
    <th>Action</th>
      ...
      <?php
	$i=0;
	$selQry= "select * from tbl_agent a inner join tbl_place p on a.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where agent_status=1";
  ...
  <tr>
    ...
    <td><a href="Acceptedagency.php?rid=<?php echo $data["agent_id"] ?>">reject</a></td>
<?php
	}
?>
  </tr>
