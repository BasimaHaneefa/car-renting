...
if(isset($_GET["rid"]))
{
	$upqry="update tbl_agent set agent_status=2 where agent_id='".$_GET["rid"]."' ";
	$Conn->query($upqry);
	header("location:Agentverification.php");	
}
?>
...
<h3 align="center" >Seater</h3>
    <tr style="background-color:#0033c4;color:white">
      ...
      <th>Action</th>
        ...
        <?php
	$i=0;
	$selQry= "select * from tbl_agent a inner join tbl_place p on a.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where agent_status=0";
    ...
    <tr>
      ...
      <td colspan=2><a href="Agentverification.php?aid=<?php echo $data["agent_id"] ?>">Accept</a>||
      <a href="Agentverification.php?rid=<?php echo $data["agent_id"] ?>">reject</a></td>
    </tr>
	<?php
	}
	?>
