...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Car Booking Report</h1>
        <br><br>
			 ...
			 $selQry = "select * from tbl_brand";
				 ...
				 $rs = $Conn->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "SELECT COALESCE(COUNT(booking_id),0) as num from tbl_booking b inner join tbl_car c on c.car_id=b.car_id inner join tbl_brand br on br.brand_id=c.brand_id where c.brand_id='".$data["brand_id"]."'";
