...
?>  
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="Guest/Customer.php" class="nav-link">Customer Registration</a></li>
                  <li><a href="Guest/Agent.php" class="nav-link">Agent Registration</a></li>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('Assets/Template/Main/images/hero_1.jpg')">
        <div class="container">
          ...
          <h2 align="center" style="color:white"><b>Welcome To Car Rental<b></h2>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="nonloop-block-13 owl-carousel">
                <?php
                    $selQry="select * from tbl_car c inner join tbl_brand b on c.brand_id=b.brand_id inner join tbl_seater s on s.seater_id=c.seater_id";
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row">
          <?php 
            $sel="select * from tbl_feedback f inner join tbl_customer c on c.customer_id=f.customer_id";
            $rowQ=$Conn->query($sel);
            while($datQ=$rowQ->fetch_assoc())
            {
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              <blockquote class="mb-4">
                <p>"<?php  echo $datQ["feedback_content"] ?>"</p>
              </blockquote>
              <div class="d-flex v-card align-items-center">
                <img src="Assets/Files/Customer/<?php  echo $datQ["customer_photo"] ?>" alt="Image" class="img-fluid mr-3">
                <span><?php echo $datQ["customer_name"] ?></span>
              </div>
            </div>
          </div>
          <?php
