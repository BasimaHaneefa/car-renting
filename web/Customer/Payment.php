...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    {
         $up ="update tbl_booking set payment_status='1' where booking_id='".$_GET["bid"]."'";
        if($Conn->query($up))
        {?>
      <script type="text/javascript">
            alert("Payment Completed");
            setTimeout(function(){window.location.href='Viewbooking.php'},100);
        </script><?php
        }
    }
            ...
            <div class="payment">
                ...
                <div class="form">
                    ...
                    <div class="card space icon-relative">
                            ...
                            <input type="text" class="input"  placeholder="Amount"  value="Rs.<?php echo $datas["paying_amount"] ?>" readonly>
